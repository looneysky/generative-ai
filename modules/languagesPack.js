...
const translations = {
    en: {
        ...
        errorMessage: '❌ An error occurred while generating the image. Please ensure that your request contains at least 5 characters. If you are requesting 18+ content generation, please check if the selected model supports such content.',
    ...
    ru: {
        ...
        errorMessage: '❌ Произошла ошибка при генерации изображения. Пожалуйста, убедитесь, что ваш запрос содержит не менее 5 символов. Если вы запрашиваете генерацию контента 18+, проверьте, поддерживает ли выбранная модель такой контент.',
